...
public class Benchmark {
	...
	public static void main(String[] args) {
		...
		Integer[] arreglo_random1=prueba.crearArregloRandom(1, tamaño, tamaño);
...
//		System.out.println("Tiempo en ordenar un arreglo random, Seletion:"+(time_end-time_start));
		...
		//Probar arreglos inversos
//		
//		System.out.println("Ordenamiento Burbuja");
//		bubble.mostrarArreglo(arreglo_inverso1);
//		System.out.println();
//		time_start=System.nanoTime();
//		bubble.burbuja(arreglo_inverso1, 0, 0, null);
//		time_end=System.nanoTime();
//		System.out.println("Tiempo en ordenar un arreglo inverso, Bubble:"+(time_end-time_start));
//		
//		System.out.println();
//		
//		System.out.println("Ordenamiento de Selección");
//		selection.mostrarArreglo(arreglo_inverso2);
//		System.out.println();
//		time_start=System.nanoTime();
//		selection.selection(arreglo_inverso2);
//		time_end=System.nanoTime();
//		System.out.println("Tiempo en ordenar un arreglo inverso, Seletion:"+(time_end-time_start));
